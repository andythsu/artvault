...
public class ArtVaultSetupMenu extends JFrame implements ActionListener{ 
  ...
  JLabel parentemailLabel = new JLabel(" Email : ");
  JTextField parentemailField = new JTextField(10);
  JButton mButton2 = new JButton(" M ");
  JLabel parentcellphoneLabel = new JLabel(" Cell Phone # : ");
  JTextField parentcellphoneField = new JTextField(10);
  ...
  public ArtVaultSetupMenu() {
    ...
    qualityComboBox.addItem("Very Good");
    qualityComboBox.addItem("Good");
    qualityComboBox.addItem("Satisfied");
    qualityComboBox.addItem("damaged");
    qualityComboBox.setPreferredSize(new Dimension(100,20));
    ...
    quantityComboBox.addItem("7");
    quantityComboBox.addItem("8");
    quantityComboBox.addItem("9");
    quantityComboBox.addItem("10");
    quantityComboBox.setPreferredSize(new Dimension(50,20));
...
//    JTextField quantityField = new JTextField(10);
    ...
    pan27.add(qualityComboBox);
    pan45.add(quantityLabel);
    pan45.add(quantityComboBox);
    ...
    pan52.add(parentLabel);
    parentLabel.setFont(new Font("MONOSPACED", Font.BOLD,18));
    
    pan54.add(parentemailLabel);
    pan54.add(parentemailField);
    pan54.add(mButton2);
    pan55.add(parentcellphoneLabel);
    pan55.add(parentcellphoneField);
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    int index = inventorytable.getSelectedIndex();
    String qualityname[] = new String [150];
    //Object quality = qualityComboBox.getSelectedItem();
    //  JComboBox qualityComboBox = (JComboBox)event.getSource();
    ...
    if (command.equals("Help")) {
      ...
      aaa= (String)qualityComboBox.getSelectedItem();
...
//      }
      ...
      JOptionPane.showMessageDialog(pan1, itemnames[index]+cost[index]);
//      itemnameField.setText(itemnames[index]);
//      costField.setText(cost[index]);
//      //qualityField.setText(quality[index]);
//      //quantityField.setText(quantity[index]);
      
    }
    
    else if (command.equals("Edit")){
      itemnames[index]=itemnameField.getText();
      cost[index]=costField.getText();
      //quality[index]= qualityField.getText();
      //quantity[index]= quantityField.getText();
...
//      search=searchField.getText();
      ...
      for (int n=0; n<100; n++){   
        ...
        if (itemnames[n].equals(searchField.getText()))
        {
          
          itemnameField.setText(itemnames[n]);
          costField.setText(cost[n]);
          //qualityField.setText(quality[Qindex]);
          //quantityField.setText(quantity[Qindex]);
          break;
        }
  ...
  public static void main(String[] args) {
    ArtVaultSetupMenu frame1 = new ArtVaultSetupMenu();  //start the GUI!
  }
}
